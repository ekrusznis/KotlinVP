...
import kotlinx.android.synthetic.main.activity_daily_specials.*
import uw.ek.kotlinvp.R
import java.util.*
import kotlin.collections.ArrayList

class DailySpecials : AppCompatActivity(), CalendarController {
            ...
            if (addFromStart) {
                ...
                for (i in 1..startMonthCal.getActualMaximum(Calendar.DAY_OF_MONTH)) {
                    ...
                    eventList.add(MyCalendarEvent(day, day,
                        ...
                        SampleEvent(name = "Sub Special $i", description = "Times Available $i"))
